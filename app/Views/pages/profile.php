...
<div class="container">
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-xl-3 col-sm-6">
            ...
            <input type="text" name="nama_sales" class="form-control" id="nama_sales" disabled value="<?php echo $profile[0]['name']; ?>">
        </div>
    </div>
    <div class="form-group row mb-3">
        <div class="col-xl-3 col-sm-6 ">
            <span class="text-xs">Mitra</span>
            <input type="text" name="mitra" class="form-control form-control-user" id="mitra" disabled value="<?php echo $profile[0]['mitra']; ?>">
        </div>
        <div class="col-xl-3 col-sm-6">
            <span class="text-xs">Posisi</span>
            <input type="text" name="posisi" class="form-control form-control-user" id="posisi" disabled value="<?php echo $profile[0]['posisi']; ?>">
        </div>
    </div>
