...
<div class="container">
    ...
    <form action="<?php echo base_url('/submit-cust'); ?>" method="post">
        <!-- <?= csrf_field(); ?> -->
        ...
        <a class="d-none d-sm-inline-block btn btn-sm shadow-sm mb-2" href="<?= base_url('pages/customers'); ?>"> Cancel</a>
