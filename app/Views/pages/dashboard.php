    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-danger">Mitra</h6>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> MNA
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> SDS
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> MCP
                        </span>
                    </div>
                </div>
            </div>
