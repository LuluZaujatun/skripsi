...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dashboard BGES</h1>
        <?php
        $pdf = false;
        ...
        if ($pdf == false) {
        ?>
            <a onclick="window.open('<?= site_url('generate') ?>', 'blank')" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>
                Generate Report</a>
        <?php } ?>
    </div>
